...
export default function CustomerKhataScreen() {
  ...
  const load = useCallback(() => {
    if (!id) return;
    const all = db.getCustomerKhataEntries(id);
    setEntries(all);
    setStats(db.getCustomerKhataStats(id));
  ...
  const topPadding = Platform.OS === "web" ? 34 : insets.top;
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        <Text style={[styles.title, { color: colors.foreground, fontFamily: U }]}>گاہک کھاتا</Text>
        ...
        <View style={[styles.summaryRow]}>
          <View style={[styles.summaryCard, { backgroundColor: colors.card, borderColor: colors.border, shadowColor: colors.shadowColor }]}>
            ...
            <Text style={[styles.summaryLabel, { color: colors.mutedForeground, fontFamily: U }]}>کل وصولی</Text>
          ...
          <View style={[styles.summaryCard, { backgroundColor: colors.card, borderColor: colors.border, shadowColor: colors.shadowColor }]}>
            ...
            <Text style={[styles.summaryLabel, { color: colors.mutedForeground, fontFamily: U }]}>کل ادائیگی</Text>
        ...
        <View style={[styles.netCard, { backgroundColor: netColor + "15", borderColor: netColor + "40" }]}>
          <Text style={[styles.netLabel, { color: netColor, fontFamily: U }]}>خالص حساب</Text>
        ...
        <View style={[styles.chartCard, { backgroundColor: colors.card, borderColor: colors.border, shadowColor: colors.shadowColor }]}>
          <View style={styles.chartHeader}>
            <View style={styles.chartLegend}>
              ...
              <Text style={[styles.legendText, { color: colors.mutedForeground, fontFamily: U }]}>ادائیگی</Text>
              <View style={[styles.legendDot, { backgroundColor: colors.success }]} />
              <Text style={[styles.legendText, { color: colors.mutedForeground, fontFamily: U }]}>وصولی</Text>
            </View>
          ...
          {(["all", "income", "expense"] as const).map((f) => (
            ...
            >
              <Text style={[styles.filterText, { color: filter === f ? "#FFF" : colors.foreground, fontFamily: U }]}>
                {f === "all" ? "سب" : f === "income" ? "وصولی" : "ادائیگی"}
              </Text>
            </TouchableOpacity>
          ))}
        </View>
        ...
        {filtered.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={[styles.emptyText, { color: colors.mutedForeground, fontFamily: U }]}>اس گاہک کا کوئی حساب نہیں</Text>
          </View>
        ) : (
          filtered.map((entry) => (
            <TouchableOpacity
            ...
            >
              ...
              <View style={[styles.typePill, { backgroundColor: (entry.type === "income" ? colors.success : colors.destructive) + "20" }]}>
                <Text style={[styles.typePillText, { color: entry.type === "income" ? colors.success : colors.destructive, fontFamily: U }]}>
                  {entry.type === "income" ? "وصولی" : "ادائیگی"}
                </Text>
              </View>
            </TouchableOpacity>
          ))
      ...
      <TouchableOpacity
        style={[
          styles.fab,
          { backgroundColor: colors.primary, bottom: bottomPadding + 24, shadowColor: colors.shadowColor },
        ]}
